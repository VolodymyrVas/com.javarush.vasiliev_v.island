...
public class Settings {
  ...
  public static final Map<Class<? extends Animal>, Map<Class<? extends Animal>, Integer>> eatingProbabilities = new HashMap<>();
  ...
  static {
    ...
    Map<Class<? extends Animal>, Integer> snakeDiet = new HashMap<>();
  ...
  public static int getEatingChance(Class<? extends Animal> predator, Class<? extends Animal> prey) {
